	...
	"leading-6 data-[state=active]:font-medium text-carbon-900",
	{
		variants: {
			variant: {
				...
				"underlined-fill": [
					"h-10 dark:data-[state=active]:bg-carbon-dark-300 text-secondary-foreground dark:data-[state=active]:bg-carbon-dark-300 data-[state=active]:bg-carbon-200 data-[state=active]:text-black dark:data-[state=active]:text-white",
